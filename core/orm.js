...
export const createContentType = async contentType => client.lPush('content_types', contentType)
export const deleteContentType = async contentType => client.lRem('content_types', 1, contentType)
export const createContent = async content => client.lPush(`${nodePrefix}_${content.type}`, content.data)
export const getAllNodes = async contentType => await client.lRange(`${nodePrefix}_${contentType}`, 0, -1)
